      ...
      <div className="flex flex-col">
        {notes.map((note) => (
          <Link
            key={note.id}
            to="/notas"
            className="flex items-center justify-between gap-3 py-2.5 px-1.5 -mx-1.5 rounded-[10px] border-b border-surface-2 last:border-none transition-colors hover:bg-white/[0.025] hover:text-primary-bright"
          >
