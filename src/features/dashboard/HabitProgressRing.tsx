...
export function HabitProgressRing({ done, total, size = 46 }: HabitProgressRingProps) {
  ...
  return (
    <div className="flex items-center gap-3 shrink-0">
      <svg width={size} height={size} viewBox="0 0 46 46" className="-rotate-90 shrink-0">
        <circle cx="23" cy="23" r={RADIUS} fill="none" strokeWidth="4" className="text-surface-3" stroke="currentColor" />
        <circle
          cx="23"
          cy="23"
          r={RADIUS}
